...
const demoProfile = {
  ...
  city: "San Francisco",
  state: "California",
  hobbies: "Photography, Basketball, Travel",
  ...
  recentVoters: [
    {
      ...
      profileImage: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=500&h=500&fit=crop",
    },
    {
      id: 2,
      name: "Sophia Chen",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <Card className="bg-white/80 backdrop-blur-md border border-gray-100">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <Link href="/vote/boys" className="w-full">
